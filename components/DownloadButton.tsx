...
const DownloadButton = () => {
  return (
    <a
      href="/CV.pdf"
      download
      className="px-1 py-1 inline-block w-full lg:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3 lg:mt-0">
